        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-12 col-md-12 col-lg-4">
                ...
                <div class="row margin-v-60">
                    <div class="col-2">
                        <img loading="lazy" src="https://staging.aerial-direct.co.uk/wp-content/uploads/2024/10/AD_BRAND_ICONS_WEB_WHITE_MAIL.png" alt='email'>
                    </div>
                    <div class="col-10">
                ...
                <div class="row">
                    <div class="col-2">
                        <img loading="lazy" src="https://staging.aerial-direct.co.uk/wp-content/uploads/2024/10/AD_BRAND_ICONS_WEB_WHITE_LIVECHAT.png" alt='chat'>
                    </div>
                    <div class="col-10">
                        <h3>Live Chat</h3>
